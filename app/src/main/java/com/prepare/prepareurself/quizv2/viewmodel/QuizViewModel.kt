...
import com.prepare.prepareurself.quizv2.data.InstructionsModel
import com.prepare.prepareurself.quizv2.data.OptionsModel
import com.prepare.prepareurself.quizv2.data.QuestionModel
import com.prepare.prepareurself.quizv2.data.QuizResponseBody

class QuizViewModel(application: Application) : AndroidViewModel(application) {

    var quizResponseBodyLiveData = MutableLiveData<QuizResponseBody>()
